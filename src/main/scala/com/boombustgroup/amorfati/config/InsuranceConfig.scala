...
/** Insurance sector: life and non-life reserves, asset allocation, and
  ...
  * non-life (~90 mld PLN) reserve pools (KNF bridge prior). Three-asset
  ...
  *
  * @param lifeReserves
  *   initial life insurance reserves in raw PLN (KNF bridge prior: ~110 mld,
  *   scaled by gdpRatio)
  * @param nonLifeReserves
  *   initial non-life insurance reserves in raw PLN (KNF bridge prior: ~90 mld,
  *   scaled by gdpRatio)
  * @param govBondShare
