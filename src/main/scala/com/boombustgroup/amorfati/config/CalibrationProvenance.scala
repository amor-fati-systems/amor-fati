    ...
    private val validationEvidenceById: Map[String, CalibrationValidationEvidence] =
      Vector(
        "pop.firmSizeDist"             -> linkedEvidence(
          ...
          "EmpiricalValidationExport carries GUS Q1 2026 near-baseline source values while terminal firm-size drift remains partial.",
        ...
        "pop.firmSizeMicroShare"       -> linkedEvidence(
          ...
          "EmpiricalValidationExport carries the GUS Q1 2026 micro-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator.",
        ...
        "pop.firmSizeSmallShare"       -> linkedEvidence(
          ...
          "EmpiricalValidationExport carries the GUS Q1 2026 small-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator.",
        ...
        "pop.firmSizeMediumShare"      -> linkedEvidence(
          ...
          "EmpiricalValidationExport carries the GUS Q1 2026 medium-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator.",
        ...
        "pop.firmSizeLargeShare"       -> linkedEvidence(
          ...
          "EmpiricalValidationExport carries the GUS Q1 2026 large-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator.",
