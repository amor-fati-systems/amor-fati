...
object StateOwned:
  ...
  private val semanticsBySector: Map[Int, SectorSemantics] = Map(
    ...
    HealthcareSector    -> SectorSemantics(investmentPriority = Share.decimal(35, 2)),
    PublicSector        -> SectorSemantics(investmentPriority = Share.One, energyBufferExposure = Share.decimal(35, 2)),
    AgricultureSector   -> SectorSemantics(investmentPriority = Share.decimal(45, 2)),
  )
  ...
  def sectorSoeShare(sectorIdx: Int): Share = sectorIdx match
    ...
    case 1 => Share.decimal(20, 2) // Manufacturing — Orlen, KGHM, JSW
    case 2 => Share.decimal(5, 2)  // Retail — minimal
    case 3 => Share.decimal(30, 2) // Healthcare — public hospitals
    case 4 => Share.decimal(80, 2) // Public — by definition
    case 5 => Share.decimal(15, 2) // Agriculture — KOWR, ANR
    case _ => Share.decimal(10, 2)
