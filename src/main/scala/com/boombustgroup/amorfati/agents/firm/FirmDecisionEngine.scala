...
/** Firm decision engine: evaluates stochastic operating and technology choices.
  *
  * This module chooses a decision but does not mutate state directly. Execution
  * and post-processing live in separate modules so credit-audit and trace data
  * remain explicit products of the decision path.
  */
