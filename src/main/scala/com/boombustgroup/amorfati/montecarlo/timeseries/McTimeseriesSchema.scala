...
import com.boombustgroup.amorfati.montecarlo.core.{MetricEncoder, MetricValue}
...
object McTimeseriesSchema:
  ...
  private class Ctx(
    ...
    lazy val totalSectorOutput: PLN                                                                 =
      sectorOutputs.foldLeft(PLN.Zero)(_ + _)
  ...
  private def creditGroup: Vector[ColumnDef] = Vector(
    ...
    ColumnDef.macroPln("ConsumerInsolvencyDefault", ctx => ctx.hhAgg.totalConsumerInsolvencyDefault),
  ...
  private def diagnosticsGroup: Vector[ColumnDef] = Vector(
    ...
    ColumnDef.macroPln("BankCreditLoss_ConsumerLoanGrossDefault", ctx => ctx.bankCapital.consumerLoanGrossDefault),
    ColumnDef.macroPln("BankCreditLoss_ConsumerLoanRecovery", ctx => ctx.bankCapital.consumerLoanRecovery),
    ColumnDef.macroPln("BankCreditLoss_ConsumerLoanExpectedLoss", ctx => ctx.bankCapital.consumerLoanExpectedLoss),
    ColumnDef.macroPln("BankCreditLoss_ConsumerLoanAllowanceDraw", ctx => ctx.bankCapital.consumerLoanNplAllowanceDraw),
    ColumnDef.macroPln("BankCreditLoss_ConsumerLoanNetCapitalLoss", ctx => ctx.bankCapital.consumerLoanNplLoss),
    ColumnDef.macroPln("BankCreditLoss_ConsumerInsolvencyGrossDefault", ctx => ctx.bankCapital.consumerInsolvencyGrossDefault),
    ColumnDef.macroPln("BankCreditLoss_ConsumerInsolvencyRecovery", ctx => ctx.bankCapital.consumerInsolvencyRecovery),
    ColumnDef.macroPln("BankCreditLoss_ConsumerInsolvencyExpectedLoss", ctx => ctx.bankCapital.consumerInsolvencyExpectedLoss),
    ColumnDef.macroPln("BankCreditLoss_ConsumerInsolvencyAllowanceDraw", ctx => ctx.bankCapital.consumerInsolvencyNplAllowanceDraw),
    ColumnDef.macroPln("BankCreditLoss_ConsumerInsolvencyNetCapitalLoss", ctx => ctx.bankCapital.consumerInsolvencyNplLoss),
    ColumnDef.macroPln("BankCreditLoss_LiquidityBridgeGrossDefault", ctx => ctx.bankCapital.liquidityBridgeGrossDefault),
    ColumnDef.macroPln("BankCreditLoss_LiquidityBridgeRecovery", ctx => ctx.bankCapital.liquidityBridgeRecovery),
    ColumnDef.macroPln("BankCreditLoss_LiquidityBridgeExpectedLoss", ctx => ctx.bankCapital.liquidityBridgeExpectedLoss),
    ColumnDef.macroPln("BankCreditLoss_LiquidityBridgeAllowanceDraw", ctx => ctx.bankCapital.liquidityBridgeNplAllowanceDraw),
    ColumnDef.macroPln("BankCreditLoss_LiquidityBridgeNetCapitalLoss", ctx => ctx.bankCapital.liquidityBridgeNplLoss),
    ColumnDef(
  ...
  object Col:
    ...
    val BpoOutputShare: Col                            = lookup("BPO_OutputShare")
    val ManufOutputShare: Col                          = lookup("Manuf_OutputShare")
    val RetailOutputShare: Col                         = lookup("Retail_OutputShare")
    ...
    val FirmCreditRejectedPortfolioPreference: Col     = lookup("FirmCredit_RejectedPortfolioPreference")
