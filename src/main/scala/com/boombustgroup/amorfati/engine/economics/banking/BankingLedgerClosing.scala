...
private[banking] object BankingLedgerClosing:
  ...
  def close(
    ...
    val bankCapitalDiagnostics  = BankCapitalDiagnostics(
      ...
      firmNplLoss = bankCapitalTerms.firmNplLoss,
      mortgageNplLoss = bankCapitalTerms.mortgageNplLoss,
      consumerNplLoss = bankCapitalTerms.consumerNplLoss,
      consumerLoanGrossDefault = bankCapitalTerms.creditLosses.consumerLoan.grossDefault,
      consumerLoanRecovery = bankCapitalTerms.creditLosses.consumerLoan.recoveryFlow,
      consumerLoanExpectedLoss = bankCapitalTerms.creditLosses.consumerLoan.expectedLoss,
      consumerLoanNplAllowanceDraw = bankCapitalTerms.creditLosses.consumerLoan.allowanceDraw,
      consumerLoanNplLoss = bankCapitalTerms.consumerLoanNplLoss,
      consumerInsolvencyGrossDefault = bankCapitalTerms.creditLosses.consumerInsolvency.grossDefault,
      consumerInsolvencyRecovery = bankCapitalTerms.creditLosses.consumerInsolvency.recoveryFlow,
      consumerInsolvencyExpectedLoss = bankCapitalTerms.creditLosses.consumerInsolvency.expectedLoss,
      consumerInsolvencyNplAllowanceDraw = bankCapitalTerms.creditLosses.consumerInsolvency.allowanceDraw,
      consumerInsolvencyNplLoss = bankCapitalTerms.consumerInsolvencyNplLoss,
      liquidityBridgeGrossDefault = bankCapitalTerms.creditLosses.liquidityBridge.grossDefault,
      liquidityBridgeRecovery = bankCapitalTerms.creditLosses.liquidityBridge.recoveryFlow,
      liquidityBridgeExpectedLoss = bankCapitalTerms.creditLosses.liquidityBridge.expectedLoss,
      liquidityBridgeNplAllowanceDraw = bankCapitalTerms.creditLosses.liquidityBridge.allowanceDraw,
      liquidityBridgeNplLoss = bankCapitalTerms.liquidityBridgeNplLoss,
      corpBondDefaultLoss = bankCapitalTerms.corpBondDefaultLoss,
      firmNplAllowanceDraw = bankCapitalTerms.creditLosses.firm.allowanceDraw,
      mortgageNplAllowanceDraw = bankCapitalTerms.creditLosses.mortgage.allowanceDraw,
      consumerNplAllowanceDraw = bankCapitalTerms.creditLosses.consumer.allowanceDraw,
      bfgLevy = bfgLevy,
