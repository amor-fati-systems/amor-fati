...
object OpenEconomy:
  ...
  private val MinRealPrice         = Multiplier.decimal(1, 1)
  private val FdiAutoBoost         = Coefficient.decimal(3, 1)
  private val FdiNfaDampening      = Coefficient.decimal(5, 1)
  private val ValuationPassThrough = Coefficient.decimal(3, 1)
  private val MinErShock           = ExchangeRateShock.decimal(-9999, 4)
