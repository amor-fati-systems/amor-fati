...
object PriceLevel:
  ...
  private val DemandPullWeight       = Coefficient.decimal(15, 2)  // sensitivity of inflation to demand gap
  private val DemandSlackPassThrough = Coefficient.decimal(25, 2)  // partial downside pass-through under slack demand
  private val CostPushWeight         = Coefficient.decimal(25, 2)  // wage growth pass-through to prices
  private val ImportPushWeight       = Coefficient.decimal(25, 2)  // FX depreciation pass-through
  private val DeflationFloor         = Coefficient.decimal(-15, 3) // soft floor: −1.5%/month
  private val FloorPassThrough       = Coefficient.decimal(3, 1)   // beyond floor, 30% pass-through
  private val SmoothingLambda        = Share.decimal(3, 1)         // EWM weight on new observation
  private val MinPriceLevel          = PriceIndex.decimal(30, 2)   // absolute floor on price index
