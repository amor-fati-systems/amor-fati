...
class BankFailureAblationExportSpec extends AnyFlatSpec with Matchers:
  ...
  private def seed(
    ...
    BankFailureAblationExport.SeedResult(
      ...
      cumulativePreReconciliationResidualAbs = BigDecimal("0.1"),
      ...
      firstFailurePreReconciliationResidual = BigDecimal(0),
      firstFailurePreReconRetainedIncome = BigDecimal(0),
      firstFailurePreReconRealizedCreditLoss = BigDecimal(0),
      firstFailurePreReconBfgLevy = BigDecimal(0),
      firstFailurePreReconPolishBankLevyTax = BigDecimal(0),
      firstFailurePreReconUnrealizedBondLoss = BigDecimal(0),
      firstFailurePreReconHtmRealizedLoss = BigDecimal(0),
      firstFailurePreReconEclProvisionChange = BigDecimal(0),
      firstFailurePreReconInterbankContagionLoss = BigDecimal(0),
      firstFailurePreReconCapitalDestruction = BigDecimal(0),
      firstFailurePreReconUnexplained = BigDecimal(0),
      firstFailureReconciliationResidual = BigDecimal(0),
      firstFailureWaterfallResidual = BigDecimal(0),
