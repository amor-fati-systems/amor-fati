...
object SfcMatrixRegistry:
  ...
  val instruments: Vector[InstrumentMetadata] =
    Vector(
      ...
      financial(
        ...
        "IR_L",
        RowCompleteness.Complete,
        "Household life-reserve assets and the matching insurance technical-reserve liability are persisted.",
      ),
      financial(
        ...
        "IR_N",
        RowCompleteness.Complete,
        "Household non-life reserve assets and the matching insurance technical-reserve liability are persisted.",
      ),
      financial(
        AssetType.TfiUnit,
        "TFI units",
  ...
  val mechanisms: Vector[MechanismMetadata] =
    Vector(
      ...
      mech(FlowMechanism.HhLiquidityShortfallFinancing, "Household liquidity shortfall bridge financing", "Bridge financing", "HH_{liq}"),
      mech(FlowMechanism.HhLiquidityBridgeChargeOff, "Household liquidity bridge charge-off", "Bridge charge-off", "HH_{br_d}"),
      mech(FlowMechanism.HhCcDebtService, "Consumer credit principal repayment", "CC principal", "CC_p"),
      mech(FlowMechanism.HhCcInterest, "Consumer credit interest", "CC interest", "CC_i"),
      mech(FlowMechanism.HhCcDefault, "Ordinary consumer credit default", "CC default", "CC_d"),
