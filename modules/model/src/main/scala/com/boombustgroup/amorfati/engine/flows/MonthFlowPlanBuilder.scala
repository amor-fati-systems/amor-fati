  ...
  def build(source: SameMonthFlowPlanSource)(using p: SimParams): MonthlyCalculus =
    ...
    MonthlyCalculus(
      ...
      banking = MonthlyCalculus.BankingFlowsPlan(
        ...
        bankFirmNplLoss = banking.bankCapitalDiagnostics.firmNplLoss,
        bankMortgageNplLoss = banking.bankCapitalDiagnostics.mortgageNplLoss,
        bankConsumerNplLoss = banking.bankCapitalDiagnostics.consumerNplLoss,
