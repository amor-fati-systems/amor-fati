  ...
  def scenarios(set: ScenarioSet): Vector[Scenario] =
    ...
    val all = Vector(
      ...
      Scenario(
        ...
        params = baseline.copy(household = baseline.household.copy(mpc = Share.decimal(82, 2))),
      ),
      Scenario(
        id = "mpc-high",
        ...
        params = baseline.copy(household = baseline.household.copy(mpc = Share.decimal(98, 2))),
      ),
      Scenario(
        id = "markup-high",
