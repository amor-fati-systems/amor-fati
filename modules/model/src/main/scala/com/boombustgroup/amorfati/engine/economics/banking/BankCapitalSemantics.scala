...
object BankCapitalSemantics:
  ...
  val writeSites: Vector[WriteSite] = Vector(
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/init/BankInit.scala",
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/agents/banking/BankCapitalWaterfall.scala",
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/engine/economics/banking/BankMultiBankStage.scala",
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/agents/banking/BankBondPortfolio.scala",
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/agents/InterbankContagion.scala",
        "b.copy(capital = b.capital - loss)",
      ),
      sfcTreatment =
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/agents/banking/BankFailureResolution.scala",
    ...
    WriteSite(
      ...
      source = SourceAnchor(
        "modules/model/src/main/scala/com/boombustgroup/amorfati/engine/economics/banking/BankAggregateReconciliation.scala",
