...
- `BaselineCatalog` now exposes that calibration through the exact legacy ID
  ...
  persisted bundle loader, or `PL-2025-Q4-v1` implementation;
...
not be relabeled as the unimplemented `PL-2025-Q4-v1` bundle or presented as
historical replay.
...
target identity `PL-2025-Q4-v1`, they do not claim that a corresponding bundle
...
The first-target `PL-2025-Q4-v1` bundle is the reference-economy input accepted
...
The researcher-facing identity remains `PL-2025-Q4-v1`. Detailed source periods,
...
same opening quarter produces `PL-2025-Q4-v2`; it never rewrites v1.
...
5. replace the legacy provider with the real `PL-2025-Q4-v1` bundle only after
   Q4 compilation, calibration, opening reconciliation, and validation exist;
   and
...
Research API facade, full baseline-bundle filesystem format, or real Q4
...
| R-08 | Pilot baseline | Use an accurately named legacy provider until `PL-2025-Q4-v1` is genuinely compiled and validated. | Proposed for RFC-0002 |
