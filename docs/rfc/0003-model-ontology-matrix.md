...
| BFG | `MechanismsState.bfgFundBalance` plus bank-resolution flows and diagnostics. | Deposit-guarantee and resolution institution/fund. | Named aggregate singleton | Its persistent monetary fund balance is outside `LedgerFinancialState`. | Owner accepted |
