...
| Workforce bridge | A declared relation from population primary-employment assignments to enterprise strata. | The [population employment control](pl-2025q4-v1-population-controls.md) plus a separately reviewed structural source where needed. | Keep BAEL jobholders, workplace-region employment, and REGON expected workers distinct. Reconcile only through an explicit bridge that records source, target measure, residual, and tolerance. | Planned: no employment component or workforce bridge is pinned. |
