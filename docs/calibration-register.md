...
| --- | --- | --- | --- | --- | --- | --- |
| `pop.firmSizeDist` | `STYLIZED_FACT_TARGET` | docs/empirical-validation/baseline-validation-snapshot.tsv | Firm-size distribution |  | Firm-size distribution family | EmpiricalValidationExport carries GUS Q1 2026 near-baseline source values while terminal firm-size drift remains partial. |
| `pop.firmSizeMicroShare` | `STYLIZED_FACT_TARGET` | docs/empirical-validation/baseline-validation-snapshot.tsv | Firm-size distribution - Micro |  | Micro-enterprise share | EmpiricalValidationExport carries the GUS Q1 2026 micro-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator. |
| `pop.firmSizeSmallShare` | `STYLIZED_FACT_TARGET` | docs/empirical-validation/baseline-validation-snapshot.tsv | Firm-size distribution - Small |  | Small-enterprise share | EmpiricalValidationExport carries the GUS Q1 2026 small-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator. |
| `pop.firmSizeMediumShare` | `STYLIZED_FACT_TARGET` | docs/empirical-validation/baseline-validation-snapshot.tsv | Firm-size distribution - Medium |  | Medium-enterprise share | EmpiricalValidationExport carries the GUS Q1 2026 medium-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator. |
| `pop.firmSizeLargeShare` | `STYLIZED_FACT_TARGET` | docs/empirical-validation/baseline-validation-snapshot.tsv | Firm-size distribution - Large |  | Large-enterprise share | EmpiricalValidationExport carries the GUS Q1 2026 large-enterprise bridge; terminal 60-month worker-count validation needs a horizon-matched comparator. |
