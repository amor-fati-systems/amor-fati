...
| `demand.crossSectorSpillover` | `0.65` | share | #461 GDP-growth calibration | Substitutable share of unmet sector demand that can be reallocated to slack sectors; avoids treating all sectors as perfect substitutes | Partial spillover inside `DemandEconomics.applySpillover` | `DemandEconomics` | `TUNED_NEEDS_VALIDATION` |
