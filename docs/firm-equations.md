...
| [`montecarlo/timeseries/McTimeseriesSchema.scala`](../src/main/scala/com/boombustgroup/amorfati/montecarlo/timeseries/McTimeseriesSchema.scala) | Public numeric output columns for firm behavior and diagnostics. |
