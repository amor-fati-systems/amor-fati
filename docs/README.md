...
| [docs/rfc/0003-model-ontology-matrix.md](rfc/0003-model-ontology-matrix.md) | Design proposal / RFC companion | Current-to-target ontology audit, ownership map, first-resolution recommendations, and decision register for RFC-0003. |
