...
| [docs/adr/0003-separate-verified-ledger-module.md](adr/0003-separate-verified-ledger-module.md) | ADR or decision record | Decision record for keeping the verified accounting kernel in the separate `modules/ledger` sbt module. |
