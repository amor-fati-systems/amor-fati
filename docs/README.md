...
| [docs/baselines/pl-2026q2-v1-enterprise-controls.md](baselines/pl-2026q2-v1-enterprise-controls.md) | Calibration or empirical evidence | Acquisition record, measurement boundaries, source hierarchy, and publication gates for the source-native, artifact-validated empirical enterprise-control component; crosswalk and workforce work remain blocked. |
