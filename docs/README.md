...
| [docs/baselines/pl-2025q4-v1-enterprise-controls.md](baselines/pl-2025q4-v1-enterprise-controls.md) | Calibration or empirical evidence | Acquisition record, measurement boundaries, source hierarchy, and publication gates for the planned first empirical enterprise-control component. |
| [docs/baselines/pl-2025q4-v1-population-controls.md](baselines/pl-2025q4-v1-population-controls.md) | Calibration or empirical evidence | Acquisition record, source hierarchy, transformations, and publication gates for the planned first empirical population-control component. |
