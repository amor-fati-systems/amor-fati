...
| [docs/pl-2026q2-v1-population-controls.md](pl-2026q2-v1-population-controls.md) | Calibration or empirical evidence | Acquisition record, source hierarchy, transformations, and publication gates for the first empirical population-control component. |
