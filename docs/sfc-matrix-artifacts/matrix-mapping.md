<!-- schema=sfc-matrix-v1 seed=1 month=12 commit=committed-snapshot sfc=pass matrix=pass output=symbolic-mapping -->
...
| symbolic-tfm | Loan interest | -rL_h, -rL_f, +rL, 0 |  | Firm interest paid [id: 45]<br>Mortgage interest [id: 64]<br>Consumer credit interest [id: 116]<br>Bank firm-loan interest [id: 76] |  |
...
| symbolic-tfm | Loan origination | +dL_h, +dL_f, -dL, 0 | Firm loans (FirmLoan)<br>Consumer loans (ConsumerLoan)<br>Mortgage loans (MortgageLoan)<br>NBFI loans (NbfiLoan) | Underwritten consumer credit origination [id: 38]<br>Household liquidity shortfall bridge financing [id: 115]<br>Firm new loan [id: 44]<br>Mortgage origination [id: 62]<br>NBFI loan origination [id: 104]<br>Quasi-fiscal lending [id: 110] |  |
| symbolic-tfm | Loan repayment and defaults | -repL_h, -repL_f, +repL, 0 | Firm loans (FirmLoan)<br>Consumer loans (ConsumerLoan)<br>Mortgage loans (MortgageLoan)<br>NBFI loans (NbfiLoan) | Consumer credit principal repayment [id: 39]<br>Ordinary consumer credit default [id: 40]<br>Household liquidity bridge charge-off [id: 118]<br>Firm loan repayment [id: 43]<br>Firm NPL default [id: 50]<br>Mortgage repayment [id: 63]<br>Mortgage default [id: 65]<br>NBFI repayment [id: 105]<br>NBFI default [id: 106]<br>Quasi-fiscal repayment [id: 111] |  |
| symbolic-tfm | Bond issuance and purchases | +dB_c, -dB_b, +dB_g, -dB_{nbp}, -dB_i, -dB_f, -dB_{row}, 0 | Government bonds (GovBondHTM)<br>Government bonds AFS (GovBondAFS)<br>Quasi-fiscal bonds (QuasiFiscalBond)<br>Corporate bonds (CorpBond) | Government bond primary market [id: 97]<br>Foreign government bond purchase [id: 98]<br>NBP QE government bond purchase [id: 99]<br>PPK government bond purchase [id: 8]<br>Insurance government bond purchase [id: 100]<br>TFI government bond purchase [id: 101]<br>Quasi-fiscal bond issuance [id: 107]<br>Quasi-fiscal bond amortization [id: 108]<br>Quasi-fiscal NBP absorption [id: 109]<br>Quasi-fiscal NBP bond amortization [id: 114]<br>Corporate bond issuance [id: 60]<br>Corporate bond amortization [id: 61] |  |
